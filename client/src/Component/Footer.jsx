    ...
    <footer className="bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100">
      <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
          <div><span id='Clean' className="font-semibold text-xl tracking-tight">CleanWave</span></div>
            <img id='imageeeee' src="https://s3.envato.com/files/262194812/thumbnail.png" className="mr-5 h-6 sm:h-9" alt="logo"/>
